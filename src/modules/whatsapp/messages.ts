...
export const OWNER = {
  ...
  published: (refCode: string) =>
    `✅ تم نشر العرض ${refCode} وأصبح جاهزاً.\n\nتبي أرسله للعملاء؟`,

  canceled: '❌ تم إلغاء العرض ولم يُنشر.',

  editHint:
    'أرسل التعديل كنص عادي وأنا أحدّثه.\nمثال: «السعر 950 الف» أو «الحي النرجس».',
  ...
  broadcastNoAudience:
    'ما فيه عملاء مطابقين في هذه الفترة. جرّب فترة أوسع أو انتظر عملاء جدد.',
  ...
  help:
    ...
    '• «عروضي» لعرض آخر العقارات\n' +
    '• «عملائي» لعدد العملاء\n' +
    '• «اشتراكي» لحالة الاشتراك',
};

export const LEAD = {
  greeting: (officeName: string) =>
  ...
  noMatches:
    'ما عندنا حالياً عرض مطابق، لكن سجّلنا طلبك وبنرسل لك أول ما ينزل شيء مناسب.',
